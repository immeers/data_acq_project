...
When flying internationally into the United States, this information can be very useful when planning one's travel. Based on their predicted total flight time, travellers can select connecting flights that minimize wasted time waiting around in the aiport and allow for adequate times between flights. This prediction information will also help travellers decide what time to book taxis or hire cars, or decide which airlines and airports to avoid at different times because of unreliability.
